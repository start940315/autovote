...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">97.94% <small>(95 / 97)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
var Http = module.exports = Class(function(){
  ...
  return {
    ...
    _filePost: function(){
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (uploadDir) {
        mkdir(uploadDir);
      }
    ...
    _ajaxFilePost: function(){
      ...
      var deferred = getDefer();
      var filepath = C('post_file_upload_path') || (<span class="branch-1 cbranch-no" title="branch not covered" >os.tmpdir() + '/thinkjs_upload')</span>;
