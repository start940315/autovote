...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">85.68% <small>(377 / 440)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">76.45% <small>(237 / 310)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">93.75% <small>(60 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">85.68% <small>(377 / 440)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
978
979
980</td><td class="line-coverage"><span class="cline-any cline-yes">2</span>
...
<span class="cline-any cline-yes">3077</span>
<span class="cline-any cline-yes">27948</span>
<span class="cline-any cline-yes">2</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >            length--;</span>
        ...
        for(var i = 0; i &lt; length; i++){
          ...
          if (exp === 'EXP') {
            ...
            var op = isArr ? (this.comparison[val[i][0].toUpperCase()] || val[i][0]) : <span class="branch-1 cbranch-no" title="branch not covered" >'=';</span>
              ...
              <span class="missing-if-branch" title="else path not taken" >E</span>if (item.on) {
                ...
                if (isObject(item.on)) {
                  ...
                  for(var key in item.on){
                    where.push([
                      key.indexOf('.') &gt; -1 ? <span class="branch-0 cbranch-no" title="branch not covered" >key </span>: (mTable + '.`' + key + '`'),
                      '=',
                      item.on[key].indexOf('.') &gt; -1 ? <span class="branch-0 cbranch-no" title="branch not covered" >item.on[key] </span>: (jTable + '.`' + item.on[key] + '`')
                    ].join(''));
                  }
...
<span class="cstat-no" title="statement not covered" >        fields = fields.split(',');</span>
    ...
    select: function(options){
      ...
      if (!isEmpty(cache) &amp;&amp; C('db_cache_on')) {
        var key = cache.key || <span class="branch-1 cbranch-no" title="branch not covered" >md5(sql);</span>
