...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">99.57% <small>(459 / 461)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">99.26% <small>(270 / 272)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(110 / 110)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">99.57% <small>(459 / 461)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
1117
1118
1119</td><td class="line-coverage"><span class="cline-any cline-yes">2</span>
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if(this.dbName) {
<span class="cstat-no" title="statement not covered" >        this.config.db_name = this.dbName;</span>
      }
    ...
    where: function(where, ignoreValue){
      ...
      if (isString(where)) {
        where = {_string: where};
      }else <span class="missing-if-branch" title="if path not taken" >I</span>if(ignoreValue !== undefined){
<span class="cstat-no" title="statement not covered" >        where = Filter.ignore(where, ignoreValue);</span>
      }
